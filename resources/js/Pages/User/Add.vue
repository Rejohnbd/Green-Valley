                        ...
                        <form @submit.prevent="submit">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="userFirstName" class="control-label">User First Name <span class="text-danger">*</span></label>
                                            <input type="text" v-model="form.first_name" class="form-control" id="userFirstName" placeholder="Enter User First Name" required>
                                        </div>
                                        <span class="help-block" style="color: red;">{{ errors.first_name }}</span>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="userLastName" class="control-label">User Last Name </label>
                                            <input type="text" v-model="form.last_name" class="form-control" id="userLastName" placeholder="Enter User Last Name">
                                        </div>
                                        <span class="help-block" style="color: red;">{{ errors.last_name }}</span>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="userEmail" class="control-label">User Email <span class="text-danger">*</span></label>
                                            <input type="email" v-model="form.email" class="form-control" id="userEmail" placeholder="Enter User Email" required>
                                            <span class="help-block" style="color: red;">{{ errors.email }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="help-block" style="color: red;">{{ errors.password }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="userPhone" class="control-label">User Phone Number </label>
                                            <input type="text" v-model="form.phone" class="form-control" id="userPhone" placeholder="Enter User Phone Number">
                                            <span class="help-block" style="color: red;">{{ errors.phone }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="userAddress" class="control-label">User Address </label>
                                            <textarea class="form-control" id="userAddress" v-model="form.address" rows="3" placeholder="Enter User Address"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6" v-if="form.role_id == 2">
                                        <div class="form-group">
                                            <label for="staffStartDate" class="control-label">Employee Start Date </label>
                                            ...
                                            />
                                            <span class="help-block" style="color: red;">{{ errors.start_date }}</span>
                                        </div>
                                    </div>

                                    <div class="col-md-6"  v-if="form.role_id == 2">
                                        <div class="form-group">
                                            <label for="staffEndDate" class="control-label">Employee End Date </label>
                                            ...
                                            <VueDatePicker 
                                                ...
                                                :enable-time-picker="false" 
                                            />
                                            <span class="help-block" style="color: red;">{{ errors.end_date }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="staffStatus" class="control-label">Select Active Status <span class="text-danger">*</span></label>
                                            <select class="form-control" v-model="form.active_status" id="staffStatus" required>
